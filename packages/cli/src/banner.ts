...
export function renderDirection1(): string {
  ...
  return [
    "",
    borderTop,
    `${v}  ${C.indigoSky}◯${RESET}${C.darkSlate}───►${RESET}${C.brightTeal}◯${RESET}${C.darkSlate}───►${RESET}${C.lensCyan}◯${RESET}   ${C.bold}${C.brightTeal}S T A T E S C R Y${RESET} ${C.subtleDim}v2.0.3${RESET}             ${v}`,
...
export async function animateDirection2(): Promise<void> {
  ...
  const frames = [
    ...
    [
      ` ${C.indigoSky}◯${RESET}${C.darkSlate}──►${RESET}${C.brightTeal}◯${RESET}${C.darkSlate}──►${RESET}${C.emeraldGlow}◯${RESET}  ${C.bold}${C.brightTeal}S T A T E S C R Y${RESET} ${C.subtleDim}v2.0.3${RESET}`,
...
export async function animateDirection3(): Promise<void> {
  ...
  process.stdout.write(
    `\n${C.lensCyan}👁  S T A T E S C R Y${RESET}  ${C.subtleDim}v2.0.3${RESET}\n`,
  );
